# Task 06 — Conectar Aba de Agendamentos

**Objetivo:** Integrar Scheduling Tab com a API, permitindo salvar e restaurar regras de agendamento.
...
### Modificar
- `apps/web/src/features/clinic/components/settings/tabs/scheduling-tab.tsx`

---

## Implementação

Substituir o componente `SchedulingTab` para:
...
1. **Import hooks:** `useClinicScheduling`, `useSaveClinicScheduling`
2. **Load data:** Carrega blocos de tempo e intervalo mínimo
3. **Add/Remove time blocks:** Dinâmico com IDs únicos
4. **Update interval:** Botões +/- para ajustar intervalo
5. **Save:** Envia timeBlocks e minimumInterval para API
...
- [ ] Pode adicionar/remover blocos de tempo
- [ ] Pode ajustar intervalo mínimo
